...
export default function Client({ data0 }) {
    ...
    async function fnTranslateNav(e) {
      ...
      if (currentTimeStamp > prevTimeStamp) {
        if (currentScrollY > prevScrollY && containerRef.current) {
          await animate(containerRef.current, { y: -400 }, { duration: 0.5, delay: 0.2, ease: "easeInOut" })
        } else if (currentScrollY < prevScrollY && containerRef.current) {
          animate(containerRef.current, { y: 0 }, { duration: 0.5, delay: 0.2, ease: "easeInOut" });        
          }
      }
    }
  ...
  const classNamesArrDiv2 = {
    ...
    "default": "hidden xl:flex w-full h-fit py-2 items-center flex-col justify-center bg-white dark:bg-neutral-900 group",
  }
      ...
      >
          ...
          >
            ...
            >
              ...
              <div
                className="flex flex-row items-end w-11/12 justify-between"
              >
                <div
                  className="tab"
                >
                  ...
                  >
                    {
                      sectionNames?.map((i, n) => (
                        <li
                          ...
                          key={`${i}_${n}`}
                          className="cursor-pointer uppercase text-[16px] hover:underline decoration-blue-400"
                        >
                          {i}
                        </li>
                      ))
